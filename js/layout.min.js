...
var layoutRender = {
  ...
  HeaderRender: function HeaderRender() {
    ...
    var MobileMedia = window.matchMedia('(max-width:767px)'); //Header Rendering
    ...
    document.querySelector("header").innerHTML = "<div class='gnb gnb_line'>\n        <div class='wrap'>\n            <h1><a href='".concat(mobileLink, "index.html'><img src=\"img/common/header-h1-BI.png\" alt=\"BM_BI\"></a></h1>\n                <ul class='sns_bar'>\n                    <li><a href='https://www.youtube.com/channel/UCsgs4ibSA_J4q5FC2IE5Gpw' target=\"_blank\"><img src='img/common/header-sns-icon-youtube.png' alt=\"youtube_icon\">\uC720\uD29C\uBE0C</a></li>\n                    <li><a href='https://www.facebook.com/bm9351' target=\"_blank\"><img src='img/common/header-sns-icon-fb.png' alt=\"youtube_icon\"alt=\"facebook_icon\">\uD398\uC774\uC2A4\uBD81</a></li>\n                    <li><a href='https://www.instagram.com/bmconsulting9351' target=\"_blank\"><img src='img/common/header-sns-icon-ins.png' alt=\"instar_icon\">\uC778\uC2A4\uD0C0\uADF8\uB7A8</a></li>\n                    <li><a href='https://blog.naver.com/bm9351' target=\"_blank\"><img src='img/common/header-sns-icon-blog.png' alt=\"instar_blog\">\uBE14\uB85C\uADF8</a></li>\n                </ul>\n            <div class='tel_bar'> \n                <img src=\"img/common/header-sns-icon-tel.png\" alt=\"tel_icon\">\n                <span>02&middot;1670&middot;5208</span>\n            </div>\n        </div>\n    </div>\n    <div class='gnb gnb_nav'>\n        <div class='wrap'>\n            <nav>\n                <ul class='nav_li'> \n                    <!-- className acitve/disalbe_li -->\n                    <li class='").concat(acitveList[0], "'><a href='").concat(mobileLink, "main.html?id=page1&listNo=1' class='nav_li1'><img src='img/common/header-nav-icon1.png'>\uC5B4\uB9B0\uC774 \uBCF4\uD5D8</a><p class='liner1'></p></li>\n                    <li class='").concat(acitveList[1], "'><a href='").concat(mobileLink, "main.html?id=page2&listNo=2' class='nav_li2'><img src='img/common/header-nav-icon2.png'>\uC554\uBCF4\uD5D8</a><p class='liner2'></p></li>\n                    <li class='").concat(acitveList[2], "'><a href='").concat(mobileLink, "main.html?id=page3&listNo=3' class='nav_li3'><img src='img/common/header-nav-icon3.png'>2\uB300\uC911\uB300\uC9C8\uBCD1</a><p class='liner3'></p></li>\n                    <li class='").concat(acitveList[3], "'><a href='").concat(mobileLink, "main.html?id=page4&listNo=4' class='nav_li4'><img src='img/common/header-nav-icon4.png'>\uCE58\uB9E4\uBCF4\uD5D8</a><p class='liner4'></p></li>\n                    <li class='").concat(acitveList[4], "'><a href='").concat(mobileLink, "main.html?id=page5&listNo=5' class='nav_li5'><img src='img/common/header-nav-icon5.png'>\uACE0\uAC1D\uC13C\uD130</a><p class='liner5'></p></li>\n                    <li class='").concat(acitveList[5], "'><a href='").concat(mobileLink, "main.html?id=page6&listNo=6' class='nav_li6'><img src='img/common/header-nav-icon6.png'>\uBCF4\uD5D8\uAE08\uCCAD\uAD6C</a><p class='liner6'></p></li>\n                </ul>\n            </nav>\n        </div>\n    </div>");
  },
  ...
  floatMenuRender: function floatMenuRender() {
...
var subLayoutRender = {
  ...
  subSectionRender: function subSectionRender() {
    //sub_wrap give class 
    var mainPage = document.getElementById('sub_page_main');
    mainPage.className = 'main_page ' + params.id;
  },
  subMainbannerRender: function subMainbannerRender() {
    //main banner_img,text
    var pageNo = params.listNo;
    var ThisBanner = document.getElementById('top_banner');
    ThisBanner.innerHTML = "<div class='wrap page".concat(pageNo, "'>\n                                    <h2><img src=\"img/sub_page/page").concat(pageNo, "_banner_h1.png\" alt=\"\"></h2>\n                                    <h3><img src=\"img/sub_page/page").concat(pageNo, "_banner_h2.png\" alt=\"\"></h3></div>");
  },
  section1Render: function section1Render() {
    ...
    if (pageNo <= 2) {
      Section.className = "section1 ".concat(pageID);
      Section.innerHTML = "<div class='wrap tab2_mode ".concat(pageID, "'>\n            <div class=\"left_tab tabs\" id='section_left'><h2>").concat(Section1Data[pageNo - 1].h2, "</h2><p>").concat(Section1Data[pageNo - 1].p1, "</p><p>").concat(Section1Data[pageNo - 1].p2, "</p></div>\n            <div class=\"right_tab tabs\" id='section_right'>").concat(Section1Data[pageNo - 1].SectionAnimaitionHtml, "</div>\n        </div>");
    } else if (pageNo <= 4) {
      Section.innerHTML = "<div class='wrap tab3_mode'>\n                <h2>".concat(Section1Data[pageNo - 1].h2, "</h2>\n                <p>").concat(Section1Data[pageNo - 1].p, "</p>\n                ").concat(Section1Data[pageNo - 1].SectionAnimaitionHtml, "\n            </div>");
    }
  },
  section2Render: function section2Render() {
  ...
  section3Render: function section3Render() {
    ...
    Section.innerHTML = "<h2>".concat(data[pageNo - 1].h2, "</h2>\n                                    <div class='sub_tit'>\n                                     <h3>").concat(data[pageNo - 1].h31, "</span></h3>\n                                     <h3>").concat(data[pageNo - 1].h32, "</h3>\n                                    </div>\n                                     <div class='text_box'>\n                                         <h4>\uAD6D\uB0B4 32\uAC1C \uBCF4\uD5D8\uC0AC\uC758 \uBAA8\uB4E0 \uBCF4\uD5D8\uC0C1\uD488\uC744 \uAF3C\uAF3C\uD558\uAC8C \uBD84\uC11D\uD574</h4>\n                                         <h4>").concat(data[pageNo - 1].textbox, "\uC5D0\uAC8C \uB531 \uB9DE\uB294 \uBCF4\uD5D8\uC744 \uCC3E\uC544\uC8FC\uB294 <span>1:1 \uB9DE\uCDA4 \uBCF4\uC7A5\uBD84\uC11D\uC11C\uBE44\uC2A4!</span></h4>\n                                     </div>\n                                     <img class='figure figure_left' src='img/sub_page/section3_left.png'>\n                                     <img class='figure figure_right' src='img/sub_page/section3_right.png'>\n\n                                     ");
  },
  section4Render: function section4Render() {
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        result1 = returnJson.filter(function (x) {
          return x.catekey == key[pageIndex];
        });
        var resultArray = [];

        for (var i = 0; i < result1.length; i++) {
          resultArray.push(" <div class='fn_box fn_box".concat(i, "' onclick='subLayoutRender.tabListActive(this|").concat(result1[i].no, ")'>\n                                        <img src=\"img/sub_page/section4_bedge.png\" class='bedge' alt=\"bedge\">\n                                        <div class=\"fn_icon\" style=\"background-image:url(").concat(result1[i].logo, ")\"></div>\n                                        <p>").concat(result1[i].product, "<span>").concat(result1[i].type, "</span></p>\n                                        <div class=\"more_btn\" onclick='popupRender.moreData(").concat(result1[i].no, ")'>\uC790\uC138\uD788 \uBCF4\uAE30</div>\n                                    </div>"));
        }
        ...
        Section.innerHTML = "\n                            <div class=\"wrap\">\n                            <h2>\uC2A4\uD53C\uB4DC \uBCF4\uD5D8\uBE44\uAD50</h2>\n                            <p>\uBCF4\uD5D8\uCE5C\uAD6C\uB4E4\uC5D0\uC11C \uCD94\uCC9C\uD558\uB294 \uC0C1\uD488\uC744 \uBE44\uAD50\uD574\uBCF4\uC138\uC694.<span>(\uCD5C\uB300 2\uAC1C\uC758 \uC0C1\uD488\uC744 \uBE44\uAD50\uD574\uBCF4\uC2E4 \uC218 \uC788\uC2B5\uB2C8\uB2E4.)</span></p>\n                            <div class=\"fn_boxs\">                                \n                                ".concat(replaceAll3, "\n                            </div>\n                            <div class=\"fn_btn\" onclick='popupRender.subPage(\"sub-").concat(pageIndex, "\")'>\uBCF4\uD5D8 \uBE44\uAD50\uD558\uAE30</div>\n                        </div>");
      }
    };
  ...
  arrayDish: [],
  //list Array
  tabListActive: function tabListActive(thisdata, Dataindex) {
  ...
  page5Layout: function page5Layout() {
    //page5 Layout top
  ...
  page5LayOutRender: function page5LayOutRender(division, thisTag, mode) {
    ...
    if (division == 'consult') {
      ...
      mainCon.innerHTML = "".concat(MainHtml);
    } else {
      ...
      setTimeout(function () {
        NumberRender.innerHTML = "".concat(NumberResultOk);
  ...
  mobileFnaNav: function mobileFnaNav(thisValue) {
    if (thisValue == 'all') {
  ...
  FnaRender: function FnaRender(thistag, datakey, no, limit) {
    ...
    function ListPush(no, limit) {
      for (var i = no; i < limit; i++) {
        returnQa.push("<li id='list_an".concat(i, "' onclick='subLayoutRender.thisListViewFn(").concat(i, ")'>\n                <p>\n                <span id='q_icon").concat(i, "' class='q_icon'>Q</span>\n                <b>").concat(fnareturnJson[i].cate, "</b><b class='qa_b'>").concat(fnareturnJson[i].qa, "</b>\n                </p>\n                <img src='img/sub_page/page5-down-arrow.png' id='arrow").concat(i, "' class='arrows' alt='\uB9AC\uC2A4\uD2B8 \uC624\uD508 \uD654\uC0B4\uD45C \uC774\uBBF8\uC9C0'></li>\n                    <div id='hide_an").concat(i, "' class='hide_an hide_an").concat(i, "'><p><span>A</span><b>").concat(fnareturnJson[i].an, "</b></p></div>\n                    "));
      ...
      if (this.readyState == 4 && this.status == 200) {
        ...
        if (datakey == "all") {
          ...
          for (var i = 0; i < MaxNumber - 1; i++) {
            listNumbering.push("<li class='NumberingFn' id onclick='subLayoutRender.FnaRender(this|\"all\"|".concat(i * 10, "|").concat((i + 1) * 10, "|").concat(i, ")'>").concat(i + 1, "</li>"));
          }

          listNumbering.push("<li class='NumberingFn' id \n                    onclick='subLayoutRender.FnaRender(this|\"all\"|".concat((MaxNumber - 1) * 10, "|").concat(fnareturnJson.length, "|").concat(i, ")'>").concat(MaxNumber, "</li>"));
          ...
          NavBeActive(0);
          var Fnaresult = [];
          Fnaresult = fnareturnJson.filter(function (x) {
            return x.catekey == datakey;
          });

          for (var i = 0; i < Fnaresult.length; i++) {
            returnQa.push("\n                        <li id='list_an".concat(i, "' onclick='subLayoutRender.thisListViewFn(").concat(i, ")'>\n                        <p>\n                            <span class='q_span' id='q_icon").concat(i, "' class='q_icon'>Q</span>\n                            <b>").concat(Fnaresult[i].cate, "</b><b class='qa_b'>").concat(Fnaresult[i].qa, "</b>\n                        </p>\n                        <img src='img/sub_page/page5-down-arrow.png' class='arrows' id='arrow").concat(i, "' alt='\uB9AC\uC2A4\uD2B8 \uC624\uD508 \uD654\uC0B4\uD45C \uC774\uBBF8\uC9C0'>\n                        </li>\n                            <div id='hide_an").concat(i, "' class='hide_an'>\n                            <p><span>A</span><b>").concat(Fnaresult[i].an, "</b></p>\n                            </div>\n                            "));
        ...
        ;
        FnaRendeing.innerHTML = "<ul>".concat(replaceQas, "</ul>");
      }
    };
  ...
  DataNumbering: function DataNumbering() {
  ...
  thisListViewFn: function thisListViewFn(key) {
    //page5 FnA Data hide,show
    var OpenList = "hide_an".concat(key);
    var Qicon = "q_icon".concat(key);
    var Arrows = "arrow".concat(key);
    ...
    $(".hide_an").slideUp(250);
    $(OpenTag).slideToggle(250); // OpenTag.style.display = "block"
  },
  page6Layout: function page6Layout() {
    //page6Layout Render
    layoutRender.getQueryString();
    var pageNo = params.listNo;
    var Section1 = document.getElementById('section1');
  ...
  page6DataRending: function page6DataRending() {
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        Cate1result = billreturnJson.filter(function (x) {
          return x.catekey == "cate1";
        });
        Cate2result = billreturnJson.filter(function (x) {
          return x.catekey == "cate2";
        });

        for (var i = 0; i < Cate1result.length; i++) {
          billreturnJsonArrayLeft.push("<div class='tb_body'>\n                            <div class='colum colum1'>".concat(Cate1result[i].insname, "</div>\n                                <div class='colum colum2'>").concat(Cate1result[i].number, "</div>\n                                <div class='colum colum3'><a href='http://bmcompany.kr/").concat(Cate1result[i].billfile, "' target='__blank'><img src='img/sub_page/pdf.png'></a></div>\n                                <div class='colum colum4'><a href='http://").concat(Cate1result[i].hompage, "'>").concat(Cate1result[i].hompage, "</a></div>\n                            </div>"));
        }

        for (var i = 0; i < Cate2result.length; i++) {
          billreturnJsonArrayRight.push("<div class='tb_body'>\n                            <div class='colum colum1'>".concat(Cate2result[i].insname, "</div>\n                                <div class='colum colum2'>").concat(Cate2result[i].number, "</div>\n                                <div class='colum colum3'><a href='http://bmcompany.kr/").concat(Cate2result[i].billfile, "' target='__blank'><img src='img/sub_page/pdf.png'></a></div>\n                                <div class='colum colum4'><a href='http://").concat(Cate2result[i].hompage, "'>").concat(Cate2result[i].hompage, "</a></div>\n                            </div>"));
        }
...
var result1, result2;
var popupRender = {
  moreData: function moreData(datakey) {
    ...
    if (result1[0].ageprice.length == 1) {
      ...
      priceHtml1.push("<div class='null_data'>\n                <span>\uCD9C\uC0DD \uC804 </span>".concat(objectKeyArrays[0], "\uC6D0 \n                </div>"));
      ...
      priceHtml1.push("<div class='price_bord'>\n                <div class='tb_head row'>\n                        <div class='colum colum-4  colum_head'>-</div>\n                        <div class='colum colum-4 colum_body'>".concat(Object.keys(result1[0].agepricem[0]), "\uC138</div>\n                        <div class='colum colum-4 colum_body'>").concat(Object.keys(result1[0].agepricem[1]), "\uC138</div>\n                        <div class='colum colum-4 colum_body'>").concat(Object.keys(result1[0].agepricem[2]), "\uC138</div>\n\n                    </div>\n                    <div class='tb_body1 row'>\n                        <div class='colum colum-4 colum_body'><span class='gender_mark man_mark'>\uB0A8</span></div>\n                        <div class='colum colum-4 colum_body'>").concat(objectKeyArrayMan[0], "\uC6D0</div>\n                        <div class='colum colum-4 colum_body'>").concat(objectKeyArrayMan[1], "\uC6D0</div>\n                        <div class='colum colum-4 colum_body'>").concat(objectKeyArrayMan[2], "\uC6D0</div>\n                    </div>\n                    <div class='tb_body2 row'>\n                    <div class='colum colum-4 colum_body'><span class='gender_mark woman_mark'>\uC5EC</span></div>\n                    <div class='colum colum-4 colum_body'>").concat(objectKeyArrayWoMan[0], "\uC6D0</div>\n                    <div class='colum colum-4 colum_body'>").concat(objectKeyArrayWoMan[1], "\uC6D0</div>\n                    <div class='colum colum-4 colum_body'>").concat(objectKeyArrayWoMan[2], "\uC6D0</div>\n                </div>\n                </div>"));
  ...
  arrayDish: [],
  applyUserinfo: [],
  closepopup: function closepopup(target) {
    if (target == 'popup') {
      var popup = document.getElementById('popup_box');
  ...
  returnFn: function returnFn(mode) {
    var _this = this;
  ...
  subPage: function subPage(Nodes) {
    var _this2 = this;
    ...
    if (this.arrayDish.length == 2) {
      ...
      setTimeout(function () {
        ...
        _this2.compareTabRnder("sub", Nodes);
      }, 500);
      $('html, body').css({
        'overflow-y': 'hidden'
      }); // fnsubBox.id = '';
  ...
  popupHead: function popupHead(b) {
    var popuptit = b == 'cal' ? '스피드보험비교' : '보험 셀프 계산기'; // const fnKey = b == 'speed' ? 'cal' : 'speed';

    _popuphead = "<h2>".concat(popuptit, "</h2>\n        <div class='popup_nav'>\n            <div class='popup_list popup_list1 active' onclick='popupRender.tabData(0,\"").concat(b, "\"), popupRender.tabListActive(0,this,\"nav\")'><img src='img/common/header-nav-icon1.png'>\uC5B4\uB9B0\uC774\uBCF4\uD5D8</div>\n            <div class='popup_list popup_list2' onclick='popupRender.tabData(1,\"").concat(b, "\"), popupRender.tabListActive(1,this,\"nav\")'><img src='img/common/header-nav-icon2.png'>\uC554\uBCF4\uD5D8</div>\n            <div class='popup_list popup_list3' onclick='popupRender.tabData(2,\"").concat(b, "\"), popupRender.tabListActive(2,this,\"nav\")'><img src='img/common/header-nav-icon3.png'>2\uB300\uC911\uB300\uC9C8\uBCD1</div>\n            <div class='popup_list popup_list4' onclick='popupRender.tabData(3,\"").concat(b, "\"), popupRender.tabListActive(3,this,\"nav\")'><img src='img/common/header-nav-icon4.png'>\uCE58\uB9E4\uBCF4\uD5D8</div>\n        </div>");
  },
  speedpopup: function speedpopup(a) {
    var _this3 = this;
    ...
    setTimeout(function () {
      _this3.tabData(0, 'cal');
    }, 700);
    $('html, body').css({// 'overflow-y': 'hidden'
    });
  },
  calculateFn: function calculateFn(a) {
    var _this4 = this;
    ...
    setTimeout(function () {
      _this4.tabData(0, 'speed');
    }, 600);
    $('html, body').css({
      'overflow-y': 'hidden'
    });
  },
  tabListActive: function tabListActive(index, thisdata, mode1, Dataindex, mode2) {
    this.applyUserinfo = [];
    ...
    if (mode2 == 'cal') {
      ...
      if (mode1 == 'nav') {
        ...
        for (i = 0; i < popupList.length; i++) {
          popupList[i].className = "popup_list popup_list".concat(i + 1);
        }

        thisdata.className = "popup_list popup_list".concat(index + 1, " active");
        this.arrayDish = [];
      } else if (mode1 == 'tab') {
        if (this.arrayDish.length < 2) {
          if (thisdata.id == '') {
  ...
  tabData: function tabData(a, b) {
    var popupCaption = b == 'speed' ? '' : '최대 2개까지 보험비교를 하실 수 있습니다';
    var mode2 = b == 'speed' ? 'cal' : 'speed';
    var pageIndex = a;
    var key = ["baby", "cancer", "disease", "dementia"];
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        for (var i = 0; i < result.length; i++) {
          resultArray.push("<div class='ins_tab ins_tab".concat(i + 1, "' onclick='popupRender.tabListActive(").concat(i + 1, "|this|\"tab\"|").concat(result[i].no, "|\"").concat(mode2, "\")'>\n                            <img src=\"img/sub_page/section4_bedge.png\" class='bedge' alt=\"bedge\">\n                            <div class='icon_area' style=\"background-image:url(").concat(result[i].logo, ")\"></div>\n                            <p>").concat(result[i].product, "</p>\n                        </div>"));
        }
        ...
        var btnData = b == 'speed' ? "<div class='cal_fn_btn' id='compare_fn_btn' onclick='popupRender.applyFn()'>\uBCF4\uD5D8\uB8CC \uACC4\uC0B0\uD558\uAE30</div>" : "<div class='compare_fn_btn' id='compare_fn_btn' onclick='popupRender.compareTabRnder(\"main\"|\"main_compare\")'>\uBCF4\uD5D8 \uBE44\uAD50\uD558\uAE30</div>";
        resultArray.push("".concat(btnData));
        var resultArrayHtml = resultArray.toString();
        var replaceAll1 = resultArrayHtml.replaceAll(',', '');
        var replaceAll2 = replaceAll1.replaceAll('|', ',');
        var replaceAll3 = replaceAll2.replaceAll(null, ' ');
        insTab.innerHTML = "<h3>".concat(popupCaption, "</h3>").concat(replaceAll3);
      }
    };
  ...
  applyFn: function applyFn() {
    ...
    var Checked = document.getElementById('agree_check').checked; // var Btns = document.getElementById('submit_btns')
      ...
      if (this.arrayDish.length > 0) {
        ...
        setTimeout(function () {
          if (DBreturnJson.phpresult == 'ok') {
            ...
            _this5.calResultRender('refresh');
          }
        }, 500);
  ...
  calResultRender: function calResultRender(mode) {
    var _this6 = this;
    ...
    if (mode == 'refresh') {
      result1 = [];
      result1 = returnJson.filter(function (x) {
        return x.no == _this6.arrayDish[0];
      });
    } else {}
    ...
    if (ObjKey <= 5) {
      ...
      Productprice = "<span>\uCD9C\uC0DD\uC804:</span> ".concat(priceResultArray[0]);
      ...
      setTimeout(function () {
        ...
        if (Number(MinKey) > age) {
          Productprice = "".concat(priceResultArray[0]);
        } else if (Number(MinKey) <= age && Number(MidKey) > age) {
          Productprice = "".concat(priceResultArray[0]);
        } else if (Number(MidKey) <= age && Number(MaxKey) > age) {
          Productprice = "".concat(priceResultArray[1]);
        } else if (Number(MaxKey) < age) {
          Productprice = "".concat(priceResultArray[2]);
        }
      }, 300);
    } else {
      var Productprice;
  ...
  compareTabRnder: function compareTabRnder(accessnode, subNode) {
    var _this7 = this;
    ...
    if (this.arrayDish.length == 2) {
      result1 = returnJson.filter(function (x) {
        return x.no == _this7.arrayDish[0];
      });
      priceHtml1 = [];
      ...
      result2 = returnJson.filter(function (x) {
        return x.no == _this7.arrayDish[1];
      });
      priceHtml2 = [];
      ...
      if (result2[0].ageprice.length == 1) {
        ...
        priceHtml2.push("<div class='price_bord'>\n                <div class='tb_head row'>\n                        <div class='colum colum-4  colum_head'>-</div>\n                        <div class='colum colum-4 colum_body'>".concat(Object.keys(result2[0].agepricem[0]), "\uC138</div>\n                        <div class='colum colum-4 colum_body'>").concat(Object.keys(result2[0].agepricem[1]), "\uC138</div>\n                        <div class='colum colum-4 colum_body'>").concat(Object.keys(result2[0].agepricem[2]), "\uC138</div>\n\n                    </div>\n                    <div class='tb_body1 row'>\n                        <div class='colum colum-4 colum_body'><span class='gender_mark man_mark'>\uB0A8</span></div>\n                        <div class='colum colum-4 colum_body'>").concat(objectKeyArrayMan[0], "\uC6D0</div>\n                        <div class='colum colum-4 colum_body'>").concat(objectKeyArrayMan[1], "\uC6D0</div>\n                        <div class='colum colum-4 colum_body'>").concat(objectKeyArrayMan[2], "\uC6D0</div>\n                    </div>\n                    <div class='tb_body2 row'>\n                    <div class='colum colum-4 colum_body'><span class='gender_mark woman_mark'>\uC5EC</span></div>\n                    <div class='colum colum-4 colum_body'>").concat(objectKeyArrayWoMan[0], "\uC6D0</div>\n                    <div class='colum colum-4 colum_body'>").concat(objectKeyArrayWoMan[1], "\uC6D0</div>\n                    <div class='colum colum-4 colum_body'>").concat(objectKeyArrayWoMan[2], "\uC6D0</div>\n                </div>\n                </div>"));
        ...
        priceHtml2.push("          <div class='price_bord'>\n                                            <div class='tb_head row'>\n                                                    <div class='colum colum-4  colum_head'>-</div>\n                                                    <div class='colum colum-4 colum_body'>".concat(Object.keys(result2[0].ageprice[0]), "\uC138</div>\n                                                    <div class='colum colum-4 colum_body'>").concat(Object.keys(result2[0].ageprice[1]), "\uC138</div>\n                                                    <div class='colum colum-4 colum_body'>").concat(Object.keys(result2[0].ageprice[2]), "\uC138</div>\n\n                                                </div>\n                                                <div class='tb_body1 row'>\n                                                    <div class='colum colum-4 colum_body'><span class='gender_mark man_mark'>\uB0A8</span></div>\n                                                    <div class='colum colum-4 colum_body'>").concat(objectKeyArray[0], "\uC6D0</div>\n                                                    <div class='colum colum-4 colum_body'>").concat(objectKeyArray[1], "\uC6D0</div>\n                                                    <div class='colum colum-4 colum_body'>").concat(objectKeyArray[2], "\uC6D0</div>\n                                                </div>\n                                                <div class='tb_body2 row'>\n                                                <div class='colum colum-4 colum_body'><span class='gender_mark woman_mark'>\uC5EC</span></div>\n                                                <div class='colum colum-4 colum_body'>").concat(objectKeyArray[0], "\uC6D0</div>\n                                                <div class='colum colum-4 colum_body'>").concat(objectKeyArray[1], "\uC6D0</div>\n                                                <div class='colum colum-4 colum_body'>").concat(objectKeyArray[2], "\uC6D0</div>\n                                            </div>\n                                            </div>"));
      }
      ...
      if (MobileMedia.matches == true) {
        ...
        insTab.innerHTML = "<div class='mo_compare_bord'>\n                    <div class='bord_wrap'>\n                    <div class='caption'>\n                        <h3 class='result_compare'>\uC2A4\uD53C\uB4DC \uBCF4\uD5D8\uBE44\uAD50</h3>\n                        <h4>\uACE0\uAC1D\uB2D8\uC774 \uC120\uD0DD\uD558\uC2E0 \uBCF4\uD5D8\uC0C1\uD488\uC758 \uD2B9\uC9D5\uC744 \uAF3C\uAF3C\uD558\uAC8C \uBE44\uAD50\uD574\uBCF4\uC138\uC694</h4>\n                        <div class='back_btn' onclick='popupRender.returnFn(\"speed\")'>\uBCF4\uD5D8\uB8CC \uB2E4\uC2DC \uBE44\uAD50\uD558\uAE30</div>\n                        <div class='insert_btn' onclick='popupRender.insertTapRender(\"compare\",\"".concat(subNode, "\")'>\uBB34\uB8CC \uC0C1\uB2F4 \uC2E0\uCCAD\uD558\uAE30</div>\n                    </div>\n                    <div class='mo_table' id='table'>\n                        <div class='left_tab mo_tab'>\n                            <div class='top_data'>\n                            <div class='logo_section' id='result_logosection' style=\"background-image:url(").concat(result1[0].logo, ")\"></div>\n                                <div class='text_area'>\n                                    <h3 id='result_product'>").concat(result1[0].product, "</h3>\n                                    <p id='result_type'>").concat(result1[0].type, "</p>\n                                </div>\n                            </div>\n                            <div class='price_table' id=\"price_table\">\n                                ").concat(priceHtml1, "\n                            </div>\n\n                            <div class='characteristic_tab tabs'>\n                                <div class='text_area'>\n                                <p>").concat(result1[0].Characteristic1, "</p>\n                                <p>").concat(result1[0].Characteristic2, "</p>\n                                </div>\n                                \n                            </div>\n                            <div class='term_tab tabs'>\n                                    <p>").concat(result1[0].term, "</p>\n                                </div>\n                                <div class='payterm_tab tabs'>\n                                    <p>").concat(result1[0].payterm, "</p>\n                                </div>\n                                <div class='extension_tab tabs'>\n                                    <p>").concat(result1[0].extension, "</p>\n                                </div>\n                        </div>\n\n                        <div class='right_tab mo_tab'>\n                            <div class='top_data'>\n                            <div class='logo_section' id='result_logosection' style=\"background-image:url(").concat(result2[0].logo, ")\"></div>\n                                <div class='text_area'>\n                                    <h3 id='result_product'>").concat(result2[0].product, "</h3>\n                                    <p id='result_type'>").concat(result2[0].type, "</p>\n                                </div>\n                            </div>\n                            <div class='price_table' id=\"price_table\">\n                                ").concat(priceHtml2, "\n                            </div>\n                            <div class='characteristic_tab tabs'>\n                            <div class='text_area'>\n                                <p>").concat(result2[0].Characteristic1, "</p>\n                                <p>").concat(result2[0].Characteristic2, "</p>\n                                </div>\n                            </div>\n                            <div class='term_tab tabs'>\n                                    <p>").concat(result2[0].term, "</p>\n                                </div>\n                                <div class='payterm_tab tabs'>\n                                    <p>").concat(result2[0].payterm, "</p>\n                                </div>\n                                <div class='extension_tab tabs'>\n                                    <p>").concat(result2[0].extension, "</p>\n                                </div>\n                        </div>\n\n\n                        <div class='center_tab'>\n                            <div class='top_tab'>\n                                <div class='swipe_img'>\n                                    <img id='swipe1' src='img/popup/swipe_img1.png'/ alt='\uC2A4\uC640\uC774\uD504\uC774\uBBF8\uC9C01'>\n                                    <img id='swipe2' src='img/popup/swipe_img2.png'/ alt='\uC2A4\uC640\uC774\uD504\uC774\uBBF8\uC9C02'>\n                                    <img id='swipe3' src='img/popup/swipe_img3.png'/ alt='\uC2A4\uC640\uC774\uD504\uC774\uBBF8\uC9C03'>\n                                </div>\n                            </div>\n                            <div class='row2_tab'>\n                                <span>\uC5F0\uB839\uBCC4</br> \uC6D4 \uBCF4\uD5D8\uB8CC</span>\n                            </div>\n                            <div class='row3_tab'>\n                                <span>\uD2B9\uC9D5</span>\n                            </div>\n                            <div class='row4_tab'>\n                                <span>\uBCF4\uD5D8\uAE30\uAC04</span>\n                            </div>\n                            <div class='row5_tab'>\n                                <span>\uB0A9\uC785\uAE30\uAC04</span>\n                            </div>\n                            <div class='row6_tab'>\n                                <span>\uAC31\uC2E0/\uBE44\uAC31\uC2E0</span>\n                            </div>\n\n                        </div>\n                    </div>\n                    </div>\n                </div>");
        $('.speed_compare_popup').animate({
          scrollTop: 200
        }, 0);
      } else {
        insTab.innerHTML = "<div class='compare_bord'>\n                <div class='bord_wrap'>\n                <div class='caption'>\n                <h3 class='result_compare'>\uC2A4\uD53C\uB4DC \uBCF4\uD5D8\uBE44\uAD50</h3>\n                <h4>\uACE0\uAC1D\uB2D8\uC774 \uC120\uD0DD\uD558\uC2E0 \uBCF4\uD5D8\uC0C1\uD488\uC758 \uD2B9\uC9D5\uC744 \uAF3C\uAF3C\uD558\uAC8C \uBE44\uAD50\uD574\uBCF4\uC138\uC694</h4>\n                <div class='back_btn' onclick='popupRender.returnFn(\"speed\")'>\uBCF4\uD5D8\uB8CC \uB2E4\uC2DC \uBE44\uAD50\uD558\uAE30</div>\n                </div>\n                    <div class='tables'>\n                        <div class='head_data data_tabs'>\n                            <div class='left_tab tabs'>\n                                <div class='logo_section' style=\"background-image:url(".concat(result1[0].logo, ")\"></div>\n                                <div class='text_area'>\n                                    <h3>").concat(result1[0].product, "</h3>\n                                    <p>").concat(result1[0].type, "</p>\n                                </div>\n                            </div>\n\n                            <div class='center_tab'></div>\n                            <div class='right_tab tabs'>\n                                <div class='logo_section' style=\"background-image:url(").concat(result2[0].logo, ")\"></div>\n                                    <div class='text_area'>\n                                        <h3>").concat(result2[0].product, "</h3>\n                                        <p>").concat(result2[0].type, "</p>\n                                    </div>\n                            </div>\n                            </div>\n                            <div class='price_tab data_tabs'>\n                            <div class='left_tab tabs'>\n                                <div class='price_bord'>\n                                    ").concat(priceHtml1, "\n                                </div>\n                            </div>\n\n                            <div class='center_tab'>\n                                <span>\uC5F0\uB839\uBCC4</br> \uC6D4 \uBCF4\uD5D8\uB8CC</span>\n                            </div>\n                            <div class='right_tab tabs'>\n                                <div class='price_bord'>\n                                ").concat(priceHtml2, "\n                                </div>\n                            </div>\n                            </div>\n                            <div class='illust_tab'>\n                                <div class='illu_tab'></div>\n                                <div class='text_tab'>\n                                    <p>\uC5B4\uB5A4 \uBCF4\uD5D8\uC744 \uC120\uD0DD\uD574\uC57C \uD560\uC9C0 \uB9C9\uB9C9 \uD558\uC2DC\uB2E4\uACE0\uC694?</p>\n                                    <p>\uD63C\uC790\uC11C \uC774\uAC83 \uC800\uAC83 \uBE44\uAD50 \uC5B4\uB835\uB2E4\uBA74 \uC804\uBB38\uC0C1\uB2F4\uC0AC\uC640 \uD568\uAED8 \uD558\uC138\uC694</p>\n                                    <p>\uD55C \uB208\uC73C\uB85C \uD655\uC778\uD558\uB294 \uBCF4\uD5D8\uC0C1\uD488 \uBCF4\uC7A5\uBD84\uC11D \uC11C\uBE44\uC2A4, 1:1 \uB9DE\uCDA4 \uBB34\uB8CC \uC9C4\uD589\uD569\uB2C8\uB2E4.</p>\n                                    <div class='consult_btn' onclick='popupRender.insertTapRender(\"compare\",\"").concat(subNode, "\")'>\uBB34\uB8CC \uC0C1\uB2F4 \uC2E0\uCCAD</div>\n                                </div>                         \n                            </div>\n                            <div class='character_data data_tabs bottom_data'>\n                            <div class='left_tab tabs'>\n                                <p>").concat(result1[0].Characteristic1, "</p>\n                                \n                            </div>\n                            <div class='center_tab'>\n                                <span>\uD2B9\uC9D5</span>\n                            </div>\n                            <div class='right_tab tabs'>\n                            <p>").concat(result2[0].Characteristic1, "</p>\n                            </div>\n                            </div>\n\n                            <div class='term_data data_tabs bottom_data'>\n                                <div class='left_tab tabs'>\n                                    <p>").concat(result1[0].term, "</p>\n                                </div>\n                                <div class='center_tab'>\n                                    <span>\uBCF4\uD5D8\uAE30\uAC04</span>\n                                </div>\n                                <div class='right_tab tabs'>\n                                <p>").concat(result2[0].term, "</p>\n                                </div>\n                            </div>\n\n                            \n                            <div class='term_data data_tabs bottom_data'>\n                                <div class='left_tab tabs'>\n                                    <p>").concat(result1[0].payterm, "\uB144</p>\n                                </div>\n                                <div class='center_tab'>\n                                    <span>\uB0A9\uC785</span>\n                                </div>\n                                <div class='right_tab tabs'>\n                                <p>").concat(result2[0].payterm, "\uB144</p>\n                                </div>\n                            </div>\n\n                            <div class='term_data data_tabs bottom_data last-row'>\n                                <div class='left_tab tabs'>\n                                    <p>").concat(result1[0].extension, "</p>\n                                </div>\n                                <div class='center_tab'>\n                                    <span>\uAC31\uC2E0/\uBE44\uAC31\uC2E0</span>\n                                </div>\n                                <div class='right_tab tabs'>\n                                <p>").concat(result2[0].extension, "</p>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>");
      }
    } else {
      alert('목록을 두개 선택해주세요');
    }
  },
  insertTapRender: function insertTapRender(accessnode, subNode) {
    var _this8 = this;
    ...
    if (returnJson != '') {
      result = returnJson.filter(function (x) {
        return x.no == _this8.arrayDish[0];
      });
    } else {
      result = returnJson.filter(function (x) {
        return x.no == _this8.arrayDish[0];
    ...
    if (accessnode == "widget") {
      ...
      var name = "";
      var Memo = "".concat(result1[0].cate, "\n").concat(result1[0].product);
      var Nodes = "cals";
    } else {
      if (result2 == undefined) {
        var name = accessnode == "calsEnd" ? "".concat(this.applyUserinfo[0].reqName) : "";
        var Memo = accessnode == "calsEnd" ? "".concat(result1[0].cate, "\n").concat(result1[0].product, "(").concat(result1[0].productcate, ")") : "";
        var Nodes = subNode != "" ? "".concat(subNode) : "".concat(accessnode);
      } else {
        var name = accessnode == "calsEnd" ? "".concat(this.applyUserinfo[0].reqName) : "";
        var Memo = accessnode == "calsEnd" ? "".concat(result[0].cate, "\n").concat(result[0].product, "(").concat(result[0].productcate, ")") : "".concat(result1[0].cate, " \uC0C1\uD488\uBE44\uAD50\n").concat(result1[0].product);
        var Nodes = subNode != "" ? "".concat(subNode) : "".concat(accessnode);
      }
    }
