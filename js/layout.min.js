...
var layoutRender = {
  ...
  HeaderRender: function HeaderRender() {
    //Header Rendering
    this.getQueryString();
    var mobileLink = params.device != undefined ? 'mo_' : '';
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        for (var i = 0; i < result.length; i++) {
          resultArray.push("<div class='ins_tab ins_tab" + (i + 1) + "' onclick='popupRender.tabListActive(" + (i + 1) + "|this|\"tab\"|" + result[i].no + "|\"" + mode2 + "\")'>\n                            <img src=\"img/sub_page/section4_bedge.png\" class='bedge' alt=\"bedge\">\n                            <div class='icon_area' style=\"background-image:url(" + result[i].logo + ")\"></div>\n                            <p>" + result[i].product + "</p>\n                        </div>");
        }
