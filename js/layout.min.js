...
var layoutRender = {
  ...
  HeaderRender: function HeaderRender() {
    this.getQueryString();
    var acitveList = ['disable_li', 'disable_li', 'disable_li', 'disable_li', 'disable_li', 'disable_li']; // console.listNo(acitveList)
    ...
    document.querySelector("header").innerHTML = "<div class='gnb gnb_line'>\n        <div class='wrap'>\n            <h1><a href='index.html'><img src=\"img/common/header-h1-BI.png\" alt=\"BM_BI\"></a></h1>\n                <ul class='sns_bar'>\n                    <li><a href='https://www.youtube.com/channel/UCsgs4ibSA_J4q5FC2IE5Gpw'><img src='img/common/header-sns-icon-youtube.png' alt=\"youtube_icon\">\uC720\uD29C\uBE0C</a></li>\n                    <li><a href='https://www.facebook.com/bm9351'><img src='img/common/header-sns-icon-fb.png' alt=\"youtube_icon\"alt=\"facebook_icon\">\uD398\uC774\uC2A4\uBD81</a></li>\n                    <li><a href='https://www.instagram.com/bmconsulting9351'><img src='img/common/header-sns-icon-ins.png' alt=\"instar_icon\">\uC778\uC2A4\uD0C0\uADF8\uB7A8</a></li>\n                    <li><a href='https://blog.naver.com/bm9351'><img src='img/common/header-sns-icon-blog.png' alt=\"instar_blog\">\uBE14\uB85C\uADF8</a></li>\n                </ul>\n            <div class='tel_bar'> \n                <img src=\"img/common/header-sns-icon-tel.png\" alt=\"tel_icon\">\n                <span>02&middot;1670&middot;5208</span>\n            </div>\n        </div>\n    </div>\n    <div class='gnb gnb_nav'>\n        <div class='wrap'>\n            <nav>\n                <ul class='nav_li'> \n                    <!-- className acitve/disalbe_li -->\n                    <li class='".concat(acitveList[0], "'><a href='main.html?id=page1&listNo=1' class='nav_li1'><img src='img/common/header-nav-icon1.png'>\uD0DC\uC544(\uC5B4\uB9B0\uC774)\uBCF4\uD5D8</a><p class='liner1'></p></li>\n                    <li class='").concat(acitveList[1], "'><a href='main.html?id=page2&listNo=2' class='nav_li2'><img src='img/common/header-nav-icon2.png'>\uC554\uBCF4\uD5D8</a><p class='liner2'></p></li>\n                    <li class='").concat(acitveList[2], "'><a href='main.html?id=page3&listNo=3' class='nav_li3'><img src='img/common/header-nav-icon3.png'>2\uB300\uC911\uB300\uC9C8\uBCD1</a><p class='liner3'></p></li>\n                    <li class='").concat(acitveList[3], "'><a href='main.html?id=page4&listNo=4' class='nav_li4'><img src='img/common/header-nav-icon4.png'>\uCE58\uB9E4\uBCF4\uD5D8</a><p class='liner4'></p></li>\n                    <li class='").concat(acitveList[4], "'><a href='javascript:fnDeleteUser()' onclick=\"alert('\uC11C\uBE44\uC2A4 \uC900\uBE44\uC911\uC785\uB2C8\uB2E4')\" class='nav_li5'><img src='img/common/header-nav-icon5.png'>\uACE0\uAC1D\uC13C\uD130</a><p class='liner5'></p></li>\n                    <li class='").concat(acitveList[5], "'><a href='javascript:fnDeleteUser()' onclick=\"alert('\uC11C\uBE44\uC2A4 \uC900\uBE44\uC911\uC785\uB2C8\uB2E4')\" class='nav_li6'><img src='img/common/header-nav-icon6.png'>\uBCF4\uD5D8\uAE08\uCCAD\uAD6C</a><p class='liner6'></p></li>\n\n                    <!-- <li class='").concat(acitveList[4], "'><a href='main.html?id=page5&listNo=5' class='nav_li5'><img src='img/common/header-nav-icon5.png'>\uACE0\uAC1D\uC13C\uD130</a><p class='liner5'></p></li> -->\n                    <!-- <li class='").concat(acitveList[5], "'><a href='main.html?id=page6&listNo=6  'class='nav_li6'><img src='img/common/header-nav-icon6.png'>\uBCF4\uD5D8\uAE08\uCCAD\uAD6C</a><p class='liner6'></p></li> -->\n                </ul>\n            </nav>\n        </div>\n    </div>");
  },
...
var subLayoutRender = {
  ...
  section4Render: function section4Render(a) {
...
var popupRender = {
  ...
  popupHead: function popupHead(b) {
    var popuptit = b == 'speed' ? '스피드보험비교' : '보험 셀프 계산기';
    var fnKey = b == 'speed' ? 'cal' : 'speed';
    _popuphead = "<h2>".concat(popuptit, "</h2>\n        <div class='popup_nav'>\n            <div class='popup_list popup_list1 active' onclick='popupRender.tabData(0,\"").concat(fnKey, "\"), popupRender.tabListActive(0,this,\"nav\")'><img src='img/common/header-nav-icon1.png'>\uD0DC\uC544(\uC5B4\uB9B0\uC774\uBCF4\uD5D8)</div>\n            <div class='popup_list popup_list2' onclick='popupRender.tabData(1,\"").concat(fnKey, "\"), popupRender.tabListActive(1,this,\"nav\")'><img src='img/common/header-nav-icon2.png'>\uC554\uBCF4\uD5D8</div>\n            <div class='popup_list popup_list3' onclick='popupRender.tabData(2,\"").concat(fnKey, "\"), popupRender.tabListActive(2,this,\"nav\")'><img src='img/common/header-nav-icon3.png'>2\uB300\uC911\uB300\uC9C8\uBCD1</div>\n            <div class='popup_list popup_list4' onclick='popupRender.tabData(3,\"").concat(fnKey, "\"), popupRender.tabListActive(3,this,\"nav\")'><img src='img/common/header-nav-icon4.png'>\uCE58\uB9E4\uBCF4\uD5D8</div>\n        </div>");
  },
  ...
  tabData: function tabData(a, b) {
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        var btnData = b == 'speed' ? "<div class='cal_fn_btn' id='compare_fn_btn' onclick='popupRender.applyFn()'>\uBCF4\uD5D8\uB8CC \uACC4\uC0B0\uD558\uAE30</div>" : "<div class='compare_fn_btn' id='compare_fn_btn' onclick='popupRender.compareTabRnder()'>\uBCF4\uD5D8 \uBE44\uAD50\uD558\uAE30</div>";
  ...
  calResultRender: function calResultRender() {
    var _this5 = this;
  ...
  compareTabRnder: function compareTabRnder(accessnode) {
    ...
    if (this.arrayDish.length == 2) {
      ...
      result2 = returnJson.filter(function (x) {
        return x.no == _this6.arrayDish[1];
      });
      priceHtml2 = [];
  ...
  insertTapRender: function insertTapRender(accessnode) {
    var _this7 = this;
    ...
    var name = this.applyUserinfo.length > 0 ? "".concat(this.applyUserinfo[0].reqName) : "";
    var Memo = this.applyUserinfo.length > 0 ? "".concat(result[0].cate, "\n").concat(result[0].product, "(").concat(result[0].productcate, ")") : "";
